...
#include "../../AttackUniversity/nivel2.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nivel2_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_nivel2_t qt_meta_stringdata_nivel2 = {
    {
QT_MOC_LITERAL(0, 0, 6), // "nivel2"
...
QT_MOC_LITERAL(16, 187, 24), // "colisionBalasConMesasETC"
QT_MOC_LITERAL(17, 212, 26), // "MoverYColisionBolasDeFuego"
...
static const uint qt_meta_data_nivel2[] = {
...
void nivel2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        nivel2 *_t = static_cast<nivel2 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 16: _t->on_ARDUINO_clicked(); break;
...
const QMetaObject nivel2::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_nivel2.data,
      qt_meta_data_nivel2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *nivel2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_nivel2.stringdata0))
        return static_cast<void*>(const_cast< nivel2*>(this));
